...
java -javaagent:/Users/williambaquero/Documents/GitHub/A.D.A.M/Analisis-Dinamico/Agente-Estatico/target/analisis-dinamico-1.0-SNAPSHOT.jar=org.springframework.samples -jar target/*.jar
